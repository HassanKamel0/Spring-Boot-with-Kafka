...
public class LibraryEventsController {
    ...
    public ResponseEntity newLibraryEvent(@RequestBody @Valid LibraryEvent libraryEvent) throws ExecutionException, JsonProcessingException, InterruptedException, TimeoutException {
...
//        libraryEventsProducer.sendLibraryEvent_3rdApproach(libraryEvent);
    ...
    public ResponseEntity updateLibraryEvent(@PathVariable int id, @RequestBody @Valid LibraryEvent libraryEvent) throws JsonProcessingException, ExecutionException, InterruptedException, TimeoutException {
